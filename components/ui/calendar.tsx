...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar shrink-0 bg-background p-2 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)] max-md:[--cell-size:min(2.75rem,calc((100vw-3rem)/7))] pointer-coarse:[--cell-size:min(2.75rem,calc((100vw-3rem)/7))] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
